...
namespace ModelViewer.HelperSuiteExtension.GUI
{
    public class GuiTextBlockLoadDialog : GUITextBlock
    {
        ...
        public GUIContentLoaderModelViewer GUILoader;
        ...
        public override void Draw(HelperSuite.GUIRenderer.GUIRenderer guiRenderer, Vector2 parentPosition, Vector2 mousePosition)
        {
